...
export const MOCK_INVENTORY = [
  {
    ...
    description: 'Furadeira profissional de alto impacto com 800W de potência.',
    totalQty: 15,
    availableQty: 12,
    rentedQty: 3,
  ...
  },
  {
    ...
    category: 'Estruturas',
    description: 'Painel de andaime tubular reforçado em aço carbono.',
    totalQty: 50,
    availableQty: 20,
    rentedQty: 30,
    conditionStatus: 'Disponível' as const,
  ...
  },
  {
    ...
    description: 'Betoneira com motor monofásico, ideal para grandes obras.',
    totalQty: 5,
    availableQty: 1,
    rentedQty: 4,
    conditionStatus: 'Manutenção' as const,
  ...
  },
  {
    ...
    category: 'Ferramentas',
    description: 'Martelete 15kg para demolição pesada em concreto.',
    totalQty: 8,
    availableQty: 8,
    rentedQty: 0,
    conditionStatus: 'Disponível' as const,
